...
const FIT = {
  safety: { key: 'safety', label: 'Réaliste', color: '#16a34a', emoji: '✅' },
  target: { key: 'target', label: 'Objectif', color: '#0ea5e9', emoji: '🎯' },
  reach: { key: 'reach', label: 'Ambitieux', color: '#f59e0b', emoji: '🔥' },
}
