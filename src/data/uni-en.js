...
export const UNI_EN = {
  ...
  asu: { scholarshipNote: 'Athletic scholarships + academically accessible', swimNote: 'Elite sprint program (renowned coaching).', highlights: ['Near-constant sun', 'W. P. Carey (business)', 'Accessible admission'] },
  ...
  chapman: { scholarshipNote: 'No athletic scholarship (D3), merit aid possible', swimNote: 'D3 program in sunny Southern California.', highlights: ['Orange County', 'Modern campus', 'Close to LA'] },
}
